...
- 검증: `tests/minicad-3d.cjs` [Z1~Z8](손계산과 소수점 일치 — 빗천장 12.528㎡·박공 16.144㎡·부피 39.6㎥),
  헤드리스로 박공 지붕이 실제로 서는 것까지 확인. 캐시 `tablet107`/`3d22`.
...
- **아직 안 된 것**: 경사 면적의 견적 반영(부속표 공간면적표), 공간이 천장 매스를 참조(`space.ceilMassId`),
  벽 상단 경사(박공 벽), 세로 면 편집(벽감·아치 — 2단계).
- 검증(Z축 3층): `?test=1` **[Z01~Z24]** · `tests/minicad-3d.cjs` **[T1~T8]**(손계산 물매 4/10·기울기 21.8°) ·
  ...
  두 창에서 함께 오르고 → undo 가 한 줄기). 캐시 `tablet107`/`3d22`.
