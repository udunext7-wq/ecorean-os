...
(async()=>{
  ...
  try{
    ...
    await J(`__key('k');window.__fogOff=MC3DVIEW.scene.fog.near;MC3DVIEW.menuCmd('fog');'ok'`);
    ck(await J(`MC3DVIEW.ST.fogOn&&MC3DVIEW.scene.fog.near<__fogOff`),'안개 켜짐 (안개 시작이 가까워짐)');
