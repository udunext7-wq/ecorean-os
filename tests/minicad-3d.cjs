...
ck(/^function massSplitFace\(/m.test(fs.readFileSync(path.join(ROOT,'js','sketch.js'),'utf8'))&&/^function _massExtrudeFaceInPlace\(/m.test(fs.readFileSync(path.join(ROOT,'js','sketch.js'),'utf8'))&&/function ffTryDivide/.test(v3Src)&&/function massDivide\(/.test(fs.readFileSync(path.join(ROOT,'js','sketch.js'),'utf8')),'5차: 면 분할(Divide) · 분할면 밀기끌기(옆면 생성)');
