...
const FIXTURE_LIB={
  ...
  toilet:{name:'양변기',nameEn:'toilet',w:400,h:700,c:'#FFFFFF',shape:[
    {type:'rect',x:-200,y:-350,w:400,h:230,fill:'#F5F5F5',stroke:'#8A9194',sw:8,r:40},
    {type:'rect',x:-160,y:-322,w:320,h:64,fill:'#E8ECEC',stroke:'#A8A8A8',sw:3,r:22},
    {type:'circle',cx:95,cy:-290,r:26,fill:'#D9DCDC',stroke:'#8A9194',sw:3},
    {type:'rect',x:-145,y:-135,w:290,h:110,fill:'#F5F5F5',stroke:'#8A9194',sw:5,r:34},
    {type:'circle',cx:0,cy:115,r:205,fill:'#FFFFFF',stroke:'#8A9194',sw:8},
    {type:'circle',cx:0,cy:115,r:152,fill:'#F0F4F4',stroke:'#A8A8A8',sw:4},
    {type:'circle',cx:0,cy:115,r:96,fill:'#E2E8EA',stroke:'#A8A8A8',sw:3},
  ]},
  ...
  sink_b:{name:'세면대',nameEn:'bathroom sink (basin)',w:600,h:450,c:'#FFFFFF',shape:[
    {type:'rect',x:-300,y:-225,w:600,h:450,fill:'#F5F5F5',stroke:'#8A9194',sw:8,r:35},
    {type:'circle',cx:0,cy:25,r:172,fill:'#FFFFFF',stroke:'#8A9194',sw:6},
    {type:'circle',cx:0,cy:25,r:135,fill:'#EDF3F5',stroke:'#A8A8A8',sw:3},
    {type:'circle',cx:0,cy:60,r:22,fill:'#8A9194',stroke:'#5F6668',sw:2},
    {type:'rect',x:-16,y:-198,w:32,h:86,fill:'#A8A8A8',stroke:'#5F6668',sw:3,r:14},
    {type:'circle',cx:-70,cy:-165,r:20,fill:'#D9DCDC',stroke:'#8A9194',sw:3},
    {type:'circle',cx:70,cy:-165,r:20,fill:'#D9DCDC',stroke:'#8A9194',sw:3},
  ]},
  ...
  bathtub:{name:'욕조',nameEn:'bathtub',w:1700,h:750,c:'#F0F0F0',shape:[
    {type:'rect',x:-850,y:-375,w:1700,h:750,fill:'#F5F5F5',stroke:'#8A9194',sw:12,r:70},
    {type:'rect',x:-780,y:-310,w:1560,h:620,fill:'#E8F0F5',stroke:'#5BA0D4',sw:8,r:120},
    {type:'rect',x:-720,y:-250,w:1440,h:500,fill:'transparent',stroke:'#9CC4DE',sw:3,r:100},
    {type:'rect',x:620,y:-230,w:120,h:460,fill:'#DDE9F0',stroke:'#9CC4DE',sw:4,r:60},
    {type:'circle',cx:-700,cy:0,r:20,fill:'#8A9194',stroke:'#5F6668',sw:3},
    {type:'rect',x:-820,y:-40,w:70,h:80,fill:'#A8A8A8',stroke:'#5F6668',sw:3,r:12},
    {type:'circle',cx:-745,cy:-95,r:18,fill:'#D9DCDC',stroke:'#8A9194',sw:3},
    {type:'circle',cx:-745,cy:95,r:18,fill:'#D9DCDC',stroke:'#8A9194',sw:3},
  ]},
  ...
  shower:{name:'샤워부스',nameEn:'shower stall',w:900,h:900,c:'#5BA0D4',shape:[
    ...
    {type:'line',x1:-430,y1:430,x2:430,y2:-430,stroke:'#9CC4DE',sw:3},
    {type:'line',x1:-430,y1:130,x2:130,y2:-430,stroke:'#9CC4DE',sw:3},
    {type:'circle',cx:-330,cy:-330,r:60,fill:'#EDF6FA',stroke:'#5BA0D4',sw:5},
    {type:'circle',cx:-330,cy:-330,r:22,fill:'#5BA0D4',stroke:'#3D6473',sw:2},
    {type:'line',x1:-430,y1:-430,x2:-330,y2:-330,stroke:'#5BA0D4',sw:6},
    {type:'line',x1:-40,y1:442,x2:430,y2:442,stroke:'#3D6473',sw:10},
    {type:'circle',cx:0,cy:442,r:16,fill:'#3D6473',stroke:'#2A4652',sw:2},
    {type:'rect',x:270,y:270,w:120,h:120,fill:'#C3DCE8',stroke:'#5BA0D4',sw:4,r:10},
    {type:'line',x1:290,y1:330,x2:370,y2:330,stroke:'#5BA0D4',sw:3},
    {type:'line',x1:330,y1:290,x2:330,y2:370,stroke:'#5BA0D4',sw:3},
  ]},
  ...
  // ===== 주방 =====
  // ===== 2026-08-24: 위생기구 확충 8종 (대표 지시 — 디자인·종류 업그레이드) =====
  sink_counter_1200:{name:'카운터 세면대 1200',nameEn:'counter basin 1200',w:1200,h:550,c:'#FFFFFF',shape:[
    {type:'rect',x:-600,y:-275,w:1200,h:550,fill:'#F5F5F5',stroke:'#8A9194',sw:10,r:30},
    {type:'line',x1:-600,y1:-235,x2:600,y2:-235,stroke:'#A8A8A8',sw:4},
    {type:'rect',x:-460,y:-140,w:560,h:360,fill:'#FFFFFF',stroke:'#8A9194',sw:6,r:90},
    {type:'rect',x:-410,y:-95,w:460,h:270,fill:'#EDF3F5',stroke:'#A8A8A8',sw:3,r:70},
    {type:'circle',cx:-180,cy:40,r:22,fill:'#8A9194',stroke:'#5F6668',sw:2},
    {type:'rect',x:-196,y:-240,w:32,h:86,fill:'#A8A8A8',stroke:'#5F6668',sw:3,r:14},
    {type:'circle',cx:390,cy:40,r:60,fill:'#EDF3F5',stroke:'#A8A8A8',sw:4},
  ]},
  sink_vessel:{name:'베셀 세면대',nameEn:'vessel basin',w:600,h:500,c:'#FFFFFF',shape:[
    {type:'rect',x:-300,y:-250,w:600,h:500,fill:'#B89B6A',stroke:'#6E5D46',sw:9,r:26},
    {type:'rect',x:-270,y:-220,w:540,h:440,fill:'#CBB086',stroke:'#8F7752',sw:4,r:20},
    {type:'circle',cx:0,cy:25,r:180,fill:'#FFFFFF',stroke:'#8A9194',sw:9},
    {type:'circle',cx:0,cy:25,r:138,fill:'#EDF3F5',stroke:'#A8A8A8',sw:4},
    {type:'circle',cx:0,cy:60,r:20,fill:'#8A9194',stroke:'#5F6668',sw:2},
    {type:'rect',x:-16,y:-235,w:32,h:96,fill:'#A8A8A8',stroke:'#5F6668',sw:3,r:14},
  ]},
  sink_double_1500:{name:'더블 세면대 1500',nameEn:'double basin 1500',w:1500,h:550,c:'#FFFFFF',shape:[
    {type:'rect',x:-750,y:-275,w:1500,h:550,fill:'#F5F5F5',stroke:'#8A9194',sw:10,r:30},
    {type:'line',x1:-750,y1:-235,x2:750,y2:-235,stroke:'#A8A8A8',sw:4},
    {type:'circle',cx:-360,cy:35,r:165,fill:'#FFFFFF',stroke:'#8A9194',sw:6},
    {type:'circle',cx:-360,cy:35,r:126,fill:'#EDF3F5',stroke:'#A8A8A8',sw:3},
    {type:'circle',cx:360,cy:35,r:165,fill:'#FFFFFF',stroke:'#8A9194',sw:6},
    {type:'circle',cx:360,cy:35,r:126,fill:'#EDF3F5',stroke:'#A8A8A8',sw:3},
    {type:'rect',x:-376,y:-225,w:32,h:86,fill:'#A8A8A8',stroke:'#5F6668',sw:3,r:14},
    {type:'rect',x:344,y:-225,w:32,h:86,fill:'#A8A8A8',stroke:'#5F6668',sw:3,r:14},
  ]},
  bathtub_free:{name:'자유배치 욕조 (타원)',nameEn:'freestanding oval bathtub',w:1700,h:800,c:'#F0F0F0',shape:[
    {type:'rect',x:-850,y:-400,w:1700,h:800,fill:'#F5F5F5',stroke:'#8A9194',sw:12,r:395},
    {type:'rect',x:-770,y:-320,w:1540,h:640,fill:'#E8F0F5',stroke:'#5BA0D4',sw:8,r:318},
    {type:'rect',x:-700,y:-250,w:1400,h:500,fill:'transparent',stroke:'#9CC4DE',sw:3,r:248},
    {type:'circle',cx:-620,cy:0,r:20,fill:'#8A9194',stroke:'#5F6668',sw:3},
    {type:'circle',cx:790,cy:-180,r:34,fill:'#A8A8A8',stroke:'#5F6668',sw:4},
    {type:'line',x1:790,y1:-180,x2:700,y2:-60,stroke:'#8A9194',sw:8},
  ]},
  shower_slide:{name:'샤워부스 (슬라이딩) 1200',nameEn:'sliding shower enclosure 1200',w:1200,h:900,c:'#5BA0D4',shape:[
    {type:'rect',x:-600,y:-450,w:1200,h:900,fill:'#D4ECF5',stroke:'#5BA0D4',sw:12,r:8},
    {type:'line',x1:-560,y1:436,x2:40,y2:436,stroke:'#3D6473',sw:10},
    {type:'line',x1:-40,y1:452,x2:560,y2:452,stroke:'#3D6473',sw:10},
    {type:'line',x1:180,y1:452,x2:60,y2:452,stroke:'#5BA0D4',sw:4},
    {type:'circle',cx:0,cy:444,r:16,fill:'#3D6473',stroke:'#2A4652',sw:2},
    {type:'circle',cx:-480,cy:-330,r:60,fill:'#EDF6FA',stroke:'#5BA0D4',sw:5},
    {type:'circle',cx:-480,cy:-330,r:22,fill:'#5BA0D4',stroke:'#3D6473',sw:2},
    {type:'line',x1:-600,y1:-450,x2:-480,y2:-330,stroke:'#5BA0D4',sw:6},
    {type:'rect',x:420,y:270,w:120,h:120,fill:'#C3DCE8',stroke:'#5BA0D4',sw:4,r:10},
    {type:'line',x1:440,y1:330,x2:520,y2:330,stroke:'#5BA0D4',sw:3},
    {type:'line',x1:480,y1:290,x2:480,y2:370,stroke:'#5BA0D4',sw:3},
  ]},
  urinal:{name:'소변기',nameEn:'urinal',w:400,h:350,c:'#FFFFFF',shape:[
    {type:'rect',x:-200,y:-175,w:400,h:350,fill:'#F5F5F5',stroke:'#8A9194',sw:8,r:110},
    {type:'rect',x:-140,y:-110,w:280,h:230,fill:'#EDF3F5',stroke:'#A8A8A8',sw:4,r:90},
    {type:'circle',cx:0,cy:90,r:24,fill:'#8A9194',stroke:'#5F6668',sw:2},
    {type:'circle',cx:0,cy:-140,r:18,fill:'#D9DCDC',stroke:'#8A9194',sw:3},
  ]},
  utility_sink:{name:'다용도 세탁싱크',nameEn:'utility laundry sink',w:550,h:500,c:'#C3C7C7',shape:[
    {type:'rect',x:-275,y:-250,w:550,h:500,fill:'#D9DCDC',stroke:'#5F6668',sw:9,r:24},
    {type:'rect',x:-225,y:-190,w:450,h:390,fill:'#EDF0F0',stroke:'#8A9194',sw:5,r:30},
    {type:'circle',cx:0,cy:55,r:22,fill:'#8A9194',stroke:'#5F6668',sw:2},
    {type:'rect',x:-16,y:-245,w:32,h:90,fill:'#A8A8A8',stroke:'#5F6668',sw:3,r:14},
  ]},
  floor_drain:{name:'바닥 배수구',nameEn:'floor drain',w:150,h:150,c:'#5BA0D4',shape:[
    {type:'rect',x:-75,y:-75,w:150,h:150,fill:'#D4ECF5',stroke:'#5BA0D4',sw:5,r:10},
...
const ELECTRIC_LIB={
  ...
  // ===== 2026-08-24: 전기 확충 — 스위치 4~6구·3로·디머·분전반·특수 콘센트·월패드 (대표 지시) =====
  switch_4:{name:'스위치(4구)',nameEn:'light switch (4-gang)',size:340,c:'#7BA05B',sym:'◇',shape:[
    {type:'rect',x:-170,y:-75,w:340,h:150,fill:'#FFFFFF',stroke:'#5A5A5A',sw:5,r:5},
    {type:'rect',x:-150,y:-30,w:60,h:60,fill:'#A8A8A8',stroke:'#5A5A5A',sw:2,r:3},
    {type:'rect',x:-75,y:-30,w:60,h:60,fill:'#A8A8A8',stroke:'#5A5A5A',sw:2,r:3},
    {type:'rect',x:0,y:-30,w:60,h:60,fill:'#A8A8A8',stroke:'#5A5A5A',sw:2,r:3},
    {type:'rect',x:75,y:-30,w:60,h:60,fill:'#A8A8A8',stroke:'#5A5A5A',sw:2,r:3},
  ]},
  switch_5:{name:'스위치(5구)',nameEn:'light switch (5-gang)',size:410,c:'#7BA05B',sym:'◇',shape:[
    {type:'rect',x:-205,y:-75,w:410,h:150,fill:'#FFFFFF',stroke:'#5A5A5A',sw:5,r:5},
    {type:'rect',x:-185,y:-30,w:60,h:60,fill:'#A8A8A8',stroke:'#5A5A5A',sw:2,r:3},
    {type:'rect',x:-110,y:-30,w:60,h:60,fill:'#A8A8A8',stroke:'#5A5A5A',sw:2,r:3},
    {type:'rect',x:-35,y:-30,w:60,h:60,fill:'#A8A8A8',stroke:'#5A5A5A',sw:2,r:3},
    {type:'rect',x:40,y:-30,w:60,h:60,fill:'#A8A8A8',stroke:'#5A5A5A',sw:2,r:3},
    {type:'rect',x:115,y:-30,w:60,h:60,fill:'#A8A8A8',stroke:'#5A5A5A',sw:2,r:3},
  ]},
  switch_6:{name:'스위치(6구)',nameEn:'light switch (6-gang)',size:300,c:'#7BA05B',sym:'◇',shape:[
    {type:'rect',x:-150,y:-110,w:300,h:220,fill:'#FFFFFF',stroke:'#5A5A5A',sw:5,r:5},
    {type:'rect',x:-125,y:-85,w:60,h:60,fill:'#A8A8A8',stroke:'#5A5A5A',sw:2,r:3},
    {type:'rect',x:-30,y:-85,w:60,h:60,fill:'#A8A8A8',stroke:'#5A5A5A',sw:2,r:3},
    {type:'rect',x:65,y:-85,w:60,h:60,fill:'#A8A8A8',stroke:'#5A5A5A',sw:2,r:3},
    {type:'rect',x:-125,y:25,w:60,h:60,fill:'#A8A8A8',stroke:'#5A5A5A',sw:2,r:3},
    {type:'rect',x:-30,y:25,w:60,h:60,fill:'#A8A8A8',stroke:'#5A5A5A',sw:2,r:3},
    {type:'rect',x:65,y:25,w:60,h:60,fill:'#A8A8A8',stroke:'#5A5A5A',sw:2,r:3},
  ]},
  switch_3way:{name:'3로 스위치',nameEn:'3-way switch',size:220,c:'#7BA05B',sym:'◇',shape:[
    {type:'rect',x:-110,y:-75,w:220,h:150,fill:'#FFFFFF',stroke:'#5A5A5A',sw:5,r:5},
    {type:'rect',x:-30,y:-30,w:60,h:60,fill:'#A8A8A8',stroke:'#5A5A5A',sw:2,r:3},
    {type:'text',x:48,y:-58,text:'3',fontSize:80,fill:'#5A5A5A'},
  ]},
  dimmer:{name:'디머 스위치',nameEn:'dimmer switch',size:220,c:'#7BA05B',sym:'◇',shape:[
    {type:'rect',x:-110,y:-75,w:220,h:150,fill:'#FFFFFF',stroke:'#5A5A5A',sw:5,r:5},
    {type:'circle',cx:0,cy:0,r:45,fill:'#A8A8A8',stroke:'#5A5A5A',sw:3},
    {type:'line',x1:0,y1:0,x2:28,y2:-32,stroke:'#5A5A5A',sw:5},
    {type:'arc',cx:0,cy:0,r:60,start:150,end:390,stroke:'#7BA05B',sw:3},
  ]},
  dist_panel:{name:'분전반',nameEn:'distribution panel',size:450,c:'#C77B3F',sym:'⚡',shape:[
    {type:'rect',x:-225,y:-140,w:450,h:280,fill:'#EFEFEF',stroke:'#3E3E3E',sw:8,r:6},
    {type:'rect',x:-225,y:-140,w:450,h:60,fill:'#3E3E3E',stroke:'#1A1A1A',sw:3,r:6},
    {type:'rect',x:-185,y:-40,w:50,h:120,fill:'#C77B3F',stroke:'#8A5528',sw:3,r:4},
    {type:'rect',x:-115,y:-40,w:50,h:120,fill:'#A8A8A8',stroke:'#5A5A5A',sw:3,r:4},
    {type:'rect',x:-45,y:-40,w:50,h:120,fill:'#A8A8A8',stroke:'#5A5A5A',sw:3,r:4},
    {type:'rect',x:25,y:-40,w:50,h:120,fill:'#A8A8A8',stroke:'#5A5A5A',sw:3,r:4},
    {type:'rect',x:95,y:-40,w:50,h:120,fill:'#A8A8A8',stroke:'#5A5A5A',sw:3,r:4},
    {type:'line',x1:165,y1:-20,x2:195,y2:30,stroke:'#C77B3F',sw:8},
    {type:'line',x1:195,y1:30,x2:172,y2:36,stroke:'#C77B3F',sw:8},
    {type:'line',x1:195,y1:30,x2:189,y2:7,stroke:'#C77B3F',sw:8},
  ]},
  outlet_220:{name:'전용 콘센트(에어컨 220V)',nameEn:'dedicated AC outlet 220V',size:220,c:'#E2725B',sym:'⏻',shape:[
    {type:'rect',x:-110,y:-75,w:220,h:150,fill:'#FFFFFF',stroke:'#5A5A5A',sw:5,r:5},
    {type:'circle',cx:0,cy:0,r:52,fill:'#F5D9D2',stroke:'#E2725B',sw:5},
    {type:'circle',cx:-18,cy:0,r:9,fill:'#5A5A5A',stroke:'#3E3E3E',sw:1},
    {type:'circle',cx:18,cy:0,r:9,fill:'#5A5A5A',stroke:'#3E3E3E',sw:1},
    {type:'text',x:-52,y:56,text:'220V',fontSize:52,fill:'#E2725B'},
  ]},
  outlet_wp:{name:'방수 콘센트',nameEn:'weatherproof outlet',size:220,c:'#5B8DA0',sym:'⏻',shape:[
    {type:'rect',x:-110,y:-75,w:220,h:150,fill:'#FFFFFF',stroke:'#5A5A5A',sw:5,r:5},
    {type:'rect',x:-85,y:-58,w:170,h:116,fill:'#D4ECF5',stroke:'#5B8DA0',sw:4,r:10},
    {type:'circle',cx:-30,cy:0,r:22,fill:'#5A5A5A',stroke:'#3E3E3E',sw:2},
    {type:'circle',cx:30,cy:0,r:22,fill:'#5A5A5A',stroke:'#3E3E3E',sw:2},
    {type:'line',x1:-85,y1:-58,x2:85,y2:-58,stroke:'#5B8DA0',sw:8},
    {type:'text',x:-30,y:60,text:'WP',fontSize:48,fill:'#5B8DA0'},
  ]},
  outlet_usb:{name:'USB 콘센트',nameEn:'USB outlet',size:220,c:'#7BA05B',sym:'⏻',shape:[
    {type:'rect',x:-110,y:-75,w:220,h:150,fill:'#FFFFFF',stroke:'#5A5A5A',sw:5,r:5},
    {type:'circle',cx:-40,cy:0,r:30,fill:'#EFEFEF',stroke:'#5A5A5A',sw:3},
    {type:'rect',x:20,y:-32,w:60,h:26,fill:'#5A5A5A',stroke:'#3E3E3E',sw:2,r:4},
    {type:'rect',x:20,y:8,w:60,h:26,fill:'#5A5A5A',stroke:'#3E3E3E',sw:2,r:4},
    {type:'text',x:-104,y:58,text:'USB',fontSize:46,fill:'#7BA05B'},
  ]},
  wallpad:{name:'월패드(홈네트워크)',nameEn:'home network wall pad',size:300,c:'#5B8DA0',sym:'▣',shape:[
    {type:'rect',x:-150,y:-105,w:300,h:210,fill:'#2E2E2E',stroke:'#141414',sw:6,r:12},
    {type:'rect',x:-125,y:-80,w:250,h:160,fill:'#4A90B8',stroke:'#2E5D78',sw:3,r:6},
    {type:'circle',cx:0,cy:78,r:12,fill:'#A8A8A8',stroke:'#5A5A5A',sw:2},
  ]},
  doorbell:{name:'초인종',nameEn:'doorbell button',size:150,c:'#7BA05B',sym:'◉',shape:[
    {type:'rect',x:-75,y:-75,w:150,h:150,fill:'#FFFFFF',stroke:'#5A5A5A',sw:5,r:12},
    {type:'circle',cx:0,cy:0,r:35,fill:'#7BA05B',stroke:'#4E6B3A',sw:4},
    {type:'circle',cx:0,cy:0,r:14,fill:'#FFFFFF',stroke:'#4E6B3A',sw:2},
  ]},
