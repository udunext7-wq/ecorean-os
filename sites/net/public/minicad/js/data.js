...
// 2026-08-30: nameEn = 도면(입면도) 영문 표기용 (대표 지시)
const FLOOR_MATERIALS={
  UNDECIDED:{name:'미정',nameEn:'T.B.D.',code:'UNDECIDED'},
  STRONG:{name:'강마루',nameEn:'Laminated Wood Flooring',code:'STRONG'},
  WOOD:{name:'원목마루',nameEn:'Solid Wood Flooring',code:'WOOD'},
  REINFORCED:{name:'강화마루',nameEn:'Laminate Flooring',code:'REINFORCED'},
  LVT:{name:'데코타일(LVT)',nameEn:'Luxury Vinyl Tile (LVT)',code:'LVT'},
  PVC:{name:'장판(PVC)',nameEn:'PVC Sheet Flooring',code:'PVC'},
  TILE_PORC:{name:'포세린타일',nameEn:'Porcelain Tile',code:'TILE_PORC'},
  TILE_POLISHED:{name:'폴리싱타일',nameEn:'Polished Tile',code:'TILE_POLISHED'},
  TILE_BATH:{name:'욕실타일(논슬립)',nameEn:'Non-slip Bath Tile',code:'TILE_BATH'},
  MARBLE:{name:'대리석',nameEn:'Marble',code:'MARBLE'},
  WOOD_TILE:{name:'우드타일',nameEn:'Wood-look Tile',code:'WOOD_TILE'},
  CARPET:{name:'카펫타일',nameEn:'Carpet Tile',code:'CARPET'},
  EPOXY:{name:'에폭시(차고/창고)',nameEn:'Epoxy Coating',code:'EPOXY'},
  CONCRETE:{name:'노출콘크리트',nameEn:'Exposed Concrete',code:'CONCRETE'},
};
const WALL_MATERIALS={
  UNDECIDED:{name:'미정',nameEn:'T.B.D.',code:'UNDECIDED'},
  WP_COMPOSITE:{name:'합지벽지',nameEn:'Duplex Wallpaper',code:'WP_COMPOSITE'},
  WP_SILK:{name:'실크벽지',nameEn:'Silk Wallpaper',code:'WP_SILK'},
  WP_ECO:{name:'친환경벽지(천연)',nameEn:'Eco (Natural) Wallpaper',code:'WP_ECO'},
  WP_DESIGN:{name:'디자인벽지',nameEn:'Designer Wallpaper',code:'WP_DESIGN'},
  PAINT_WATER:{name:'페인트(수성)',nameEn:'Water-based Paint',code:'PAINT_WATER'},
  PAINT_ECO:{name:'페인트(친환경)',nameEn:'Eco-friendly Paint',code:'PAINT_ECO'},
  PAINT_SPECIAL:{name:'특수도장(스타코/벨벳)',nameEn:'Special Coating (Stucco/Velvet)',code:'PAINT_SPECIAL'},
  WALL_TILE:{name:'욕실벽타일',nameEn:'Bathroom Wall Tile',code:'WALL_TILE'},
  KITCHEN_TILE:{name:'주방벽타일',nameEn:'Kitchen Wall Tile',code:'KITCHEN_TILE'},
  WOOD_PANEL:{name:'우드패널',nameEn:'Wood Panel',code:'WOOD_PANEL'},
  VENEER:{name:'무늬목패널',nameEn:'Veneer Panel',code:'VENEER'},
  CONCRETE:{name:'노출콘크리트',nameEn:'Exposed Concrete',code:'CONCRETE'},
  FABRIC:{name:'패브릭패널',nameEn:'Fabric Panel',code:'FABRIC'},
  METAL:{name:'메탈패널',nameEn:'Metal Panel',code:'METAL'},
};
...
function defaultMaterials(spaceType){
  switch(spaceType){
    ...
    case 'FOYER':    return {floor:'TILE_PORC',wall:'WP_SILK'}; // v5.9 fix: VESTIBULE(dead key) → FOYER(전실)
